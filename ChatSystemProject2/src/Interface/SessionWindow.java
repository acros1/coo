...
public class SessionWindow extends javax.swing.JFrame {
    ...
    public SessionWindow(User u,ClientThread clientThread) {
    ...
    private void SendButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SendButtonMouseClicked
        ...
        //HERE THE MESSAGE IS SEND TO THE PERSON YOU CHAT WITH 
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        st.writeMessage(exitMessage);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SessionWindow(null,null).setVisible(true);
            }
        });
    }
